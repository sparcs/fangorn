...
abstract class LastToFirstJoin extends AbstractJoin {

	LastToFirstJoin(JoinLogicAware logic) {
		super(logic);
	}

	@Override
	public boolean shouldLoadPayload(int pos, NodeDataBuffer data) {
		return pos < data.lastPosition();
	}
...
class SimpleLTFJoin extends LastToFirstJoin {

	SimpleLTFJoin(JoinLogicAware logic) {
		super(logic);
	}
...
class SimpleLTFWithFirstCheckJoin extends LastToFirstJoin {

	SimpleLTFWithFirstCheckJoin(JoinLogicAware logic) {
		super(logic);
	}
...
class EarlyStopLTFJoin extends LastToFirstJoin {

	EarlyStopLTFJoin(JoinLogicAware logic) {
		super(logic);
	}
...
class EarlyStopLTFWithFirstCheckJoin extends LastToFirstJoin {

	EarlyStopLTFWithFirstCheckJoin(JoinLogicAware logic) {
		super(logic);
	}
